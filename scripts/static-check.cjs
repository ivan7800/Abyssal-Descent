...
const required=['index.html','main.js','phaser-lite.js','styles.css','game/DungeonScene.js','game/audio.js','game/content.js','game/generator.js']
...
if(!phaser.includes('class Game')||!phaser.includes('class Graphics'))throw new Error('Standalone canvas runtime incomplete')
