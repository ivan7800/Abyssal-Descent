...
const required=['index.html','main.js','v12.js','v12.css','i18n.js','meta.js','phaser-lite.js','styles.css','manifest.webmanifest','sw.js','icons/icon-192.png','icons/icon-512.png','game/DungeonScene.js','game/audio.js','game/content.js','game/generator.js']
...
if(!html.includes('src="./main.js"')||!html.includes('src="./v12.js"')||!html.includes('href="./styles.css"')||!html.includes('href="./v12.css"'))throw new Error('docs/index.html does not use the complete relative standalone asset set')
...
const sw=fs.readFileSync(path.join(docs,'sw.js'),'utf8');for(const marker of ['abyssal-descent-v1.2.0','caches.open','skipWaiting','clients.claim'])if(!sw.includes(marker))throw new Error(`Service worker missing ${marker}`)
