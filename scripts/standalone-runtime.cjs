...
;(async()=>{
 ...
 const exported=meta.makeExportBundle(codex,'es');if(!exported.ok||exported.bundle.gameVersion!=='1.3.0'||exported.bundle.language!=='es')throw new Error('Portable save export failed')
